...
BB_GCS_PATH="$GCS_BUCKET/screenshot-k8s-artifacts/$GIT_REF"
...
K8S_GS_PATH_BASE=$SPINNAKER_GCS_PATH/$K8S_PROVIDER/$K8S_CLUSTER/$K8S_ENV/screenshot/$GIT_REF
